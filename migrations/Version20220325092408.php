 ...
 */
final class Version20220325092408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE risk ADD probability_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE risk ADD CONSTRAINT FK_7906D541D09E6F09 FOREIGN KEY (probability_id) REFERENCES probability (id)');
        $this->addSql('CREATE INDEX IDX_7906D541D09E6F09 ON risk (probability_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_7906D541D09E6F09 ON risk');
        $this->addSql('ALTER TABLE risk DROP probability_id, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
