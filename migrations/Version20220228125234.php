 ...
 */
final class Version20220228125234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wallet ADD manager_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE wallet ADD CONSTRAINT FK_7C68921F783E3463 FOREIGN KEY (manager_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_7C68921F783E3463 ON wallet (manager_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wallet DROP FOREIGN KEY FK_7C68921F783E3463');
        $this->addSql('DROP INDEX IDX_7C68921F783E3463 ON wallet');
        $this->addSql('ALTER TABLE wallet DROP manager_id, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
